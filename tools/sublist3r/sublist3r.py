...
class DNSdumpster(enumratorBaseThreaded):
    ...
    def enumerate(self):
        ...
        # The regex to find the CSRF token
        ...
        try:
            ...
            # If the token is not found, we can't proceed with this engine.
            if self.verbose:
                self.print_(R + "[!] " + self.engine_name + ": CSRF token not found. The website may have changed." + W)
            return []
